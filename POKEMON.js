...
//    console.log('id is '+info.pokemon[i].id + '  hight is' +info.pokemon[i].height +'  weight is ' +info.pokemon[i].weight
...
//            )
//            console.log(info.pokemon[i].img)
//    }
//  }
...
// //     consol(info.pokemon[i].next_evolution[0].name+info.pokemon[i].next_evolution[1].name)
// //    }  
// //  }
...
var pokemonName = window.prompt("enter name for the infomation adout pokemon ");
findPokemonByName(pokemonName,pokemonObject)
function findPokemonByName(pokemonName, pokemonObject) {
...
// var weekness = window.prompt("enter name for the infomation adout pokemon ");
// findPokemonByName1(weekness,pokemonObject)
// function findPokemonByName1(weekness, pokemonObject) {
//    // console.log("name",weekness);
...
//     var weeknees1=[]
//     for (arrayIndex in pokemonObject.pokemon) {
//         console.log("in lpop 1",arraInedx1);
//         for(arraInedx1 in pokemonObject.pokemon[arrayIndex].weekness ){
//             console.log("in lpop 2",arraInedx1);
//             if (pokemonObject.pokemon[arrayIndex].weekness[arraInedx1].toLowerCase() == weekness.toLowerCase())
//             {
//                 flag = 1; 
//                 console.log(weeknees1)
//                 weeknees1.push(pokemonObject.pokemon[arrayIndex].name.toLowerCase())
//                 break; 
//             }
//         }
...
//     } 
//     if (flag == 1) {
//         console.log("Following is/are the pokemon's list having weakness as a " + weakness )
//         console.log(weeknees1)
//     
// }
var name_week = window.prompt("enter weeknesses find the pokemon ") 
        findPokemonByWeakness(name_week,pokemonObject)
        function findPokemonByWeakness(name_week,pokemonObject)
        {
            var flag = 0;
            var count = 0;
            var arrayIndex;
            ...
            for (arrayIndex in pokemonObject.pokemon)
                ...
                for (weaknessIndex in pokemonObject.pokemon[arrayIndex].weaknesses)
                    {
                        if (pokemonObject.pokemon[arrayIndex].weaknesses[weaknessIndex].toLowerCase() == name_week.toLowerCase()) 
                        {
            ...
            console.log(resultArray)
                ...
                console.log("weekness if not found")
            }
            

}
    
var pokemonName = window.prompt("enter name for the next evolution adout pokemon ");
 findPokemonByNextEvolution(pokemonName,pokemonObject)
 function findPokemonByNextEvolution(pokemonName, pokemonObject)
  {
   var arrayIndex;
    var flag=0;
    var resultArray = []
    for (arrayIndex in pokemonObject.pokemon)
     {
        ...
        console.log(resultArray)
            ...
            console.log("nextevolution if not found")
        }
